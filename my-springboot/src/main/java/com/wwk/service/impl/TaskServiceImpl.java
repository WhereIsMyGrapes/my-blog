...
import com.wwk.enums.TaskStatusEnum;
...
import com.wwk.quartz.utils.CronUtils;
import com.wwk.quartz.utils.ScheduleUtils;
import com.wwk.service.TaskService;
import com.wwk.mapper.TaskMapper;
...
public class TaskServiceImpl extends ServiceImpl<TaskMapper, Task> implements TaskService {
    ...
    public void updateTask(TaskDTO task) {
        ...
        Task newTask = BeanCopyUtils.copyBean(existTask, Task.class);
        // 更新定时任务

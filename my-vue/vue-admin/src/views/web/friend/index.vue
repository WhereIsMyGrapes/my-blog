    ...
    <div class="app-container">
        ...
        <el-form @submit.native.prevent :model="queryParams" :inline="true">
            <el-form-item label="友链名称">
                <el-input style="width:200px" @keyup.enter="queryParams" v-model="queryParams.keyword"
                    placeholder="请输入友链名称" clearable></el-input>
            </el-form-item>
            <el-form-item>
                <el-button @click="queryParams" icon="search" type="primary">搜索</el-button>
            </el-form-item>
        </el-form>
        <!-- 操作按钮 -->
        <el-row :gutter="10" class="mb15">
            <el-col :span="1.5">
                <el-button plain type="primary" @click="openModel(undefined)" icon="plus">新增</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button plain type="danger" @click="handleDelete(undefined)"
                    icon="delete" :disabled="friendIdList.length === 0">批量删除</el-button>
            </el-col>
            <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
        </el-row>
        <!-- 表格展示 -->
        <el-table border @selection-change="handleSelectionChange" :data="friendList" v-loading="loading">
            <!-- 表格列 -->
...
import { FriendQuery, Friend, FriendForm } from "@/api/friend/types";

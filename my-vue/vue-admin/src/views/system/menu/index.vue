    ...
    <div class="app-container">
        ...
        <el-form :model="queryParams" :inline="true" v-show="showSearch">
            <el-form-item label="菜单名称">
                <el-input @keyup.enter="handleQuery" clearable 
                   v-model="queryParams.keyword" style="width: 200px" placeholder="请输入菜单名称" />
            </el-form-item>
            <el-form-item label="状态">
                <el-select v-model="queryParams.isDisable" style="width: 200px" placeholder="请选择状态" clearable>
                    <el-option v-for="item in isDisable" :key="item.value" :label="item.label" :value="item.value"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
        ...
        <el-row :gutter="10" class="mb15">
            ...
            <el-col :span="1.5">
                <el-button type="info" plain icon="sort" @click="toggleExpandAll">折叠/展开</el-button>
            </el-col>
            <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
        </el-row>
        <!-- 表格展示 -->
        <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="id"
            :default-expand-all="isExpandAll" :tree-props="defaultProps" highlight-current-row>
            <!-- 菜单名称 -->
        ...
        <!-- 修改或添加对话框 -->
        <el-dialog :title="title" width="680px" @close="cancel" append-to-body v-model="addOrUpdate">
            <el-form ref="menuFormRef" :rules="rules" :data="menuForm" label-width="100px">
                <el-row>
                    <!-- 上级菜单 -->
                    <el-col :span="24">
...
// 折叠展开
const toggleExpandAll = (name: string) => {

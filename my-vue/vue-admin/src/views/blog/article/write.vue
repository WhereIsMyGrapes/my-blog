<template>
    <div class="app-container">
        ...
        <!-- 文章内容 -->
        <md-editor :toolbars="toolbars" ref="editorRef" v-model="articleForm.articleContent" :theme="isDark ? 'dark' : 'light'"
            class="md-container" @on-upload-img="uploadImg" placeholder="请输入文章内容...">

<template>
    <div class="app-container">
        ...
        <el-table border :data="articleList" v-loading="loading" @selection-change="handleSelectionChange">
            ...
            <!-- 略缩图 -->
            <el-table-column prop="articleCover" label="略缩图" width="180" align="center">
            ...
            <el-table-column prop="tagVOList" label="标签" width="160" align="center">
                <template #default="scope">
                    <el-tag v-for="item in scope.row.tagVOList" :key="item.tagId"
            ...
            <!-- 文章浏览量 -->
            <el-table-column prop="viewCount" label="浏览量" width="70" align="center"></el-table-column>
            <!-- 文章点赞量 -->
            <el-table-column prop="likeCount" label="点赞量" width="70" align="center"></el-table-column>
            <!-- 文章置顶 -->
            <el-table-column prop="isTop" label="置顶" width="70" align="center">
                <template #default="scope">
                    <el-switch v-model="scope.row.isTop" :disable="scope.row.isDelete"
                        style="--el-switch-on-color: #13ce66;"
                        :active-value="1" :inactive-value="0" @change="handleTop(scope.row)"
                        ></el-switch>
                </template>
            </el-table-column>
            <!-- 文章推荐 -->
            <el-table-column prop="isRecommend" label="推荐" width="70" align="center">
                <template #default="scope">
                    <el-switch v-model="scope.row.isRecommend" 
                        ...
                        style="--el-switch-on-color: #13ce66;" @change="handleRecommend(scope.row)"
                    ></el-switch>
                </template>
            </el-table-column>
                <!-- 创建时间 -->

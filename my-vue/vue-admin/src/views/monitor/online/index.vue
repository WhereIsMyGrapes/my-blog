<template>
    <div class="app-container">
        <!-- 搜索栏 -->
        <el-form :inline="true" @submit.native.prevent :model="queryParams">
            <el-form-item label="用户昵称">
                <el-input v-model="queryParams.keyword" @keyup.enter="handleQuery" clearable placeholder="请输入用户昵称" style="width: 200px" />
            </el-form-item>
            <el-form-item>
        ...
        <el-table border :data="onlineList" v-loading="loading">
            ...
            <el-table-column label="下线" align="center">
                <template #default="scope">
                    <el-button link type="primary" icon="edit" @click="kickOut(scope.row.token)">下线</el-button>                
                </template>
            </el-table-column>
        </el-table>

<template>
    <n-popover trigger="click" placement="bottom-start" style="max-height: 200px;" content-style="padding: 0 8px;"
        ...
        <template #header>
            <div class="emoji-title">{{ emojiType === 0 ? "小黄脸" : emojiType === 1 ? "小电视" : "颜文字" }}</div>
        </template>
        ...
        <template #footer>
            <div class="emoji-tabs">
                <div class="emoji-tab" :class="{ 'on': emojiType === 0 }" @click="chooseType(0)">
                    <img src="https://static.cloverkitty.love/emoji/xianqi.png" width="22" height="22" />
                </div>
                <div class="emoji-tab" :class="{ 'on': emojiType === 1 }" @click="chooseType(1)">
                    <img src="https://static.cloverkitty.love/tvEmoji/tvdz.png" width="22" height="22" />
                </div>
                <div class="emoji-tab" :class="{ 'on': emojiType === 2 }" @click="chooseType(2)">
                    <img src="https://static.cloverkitty.love/emoji/yan.png" width="22" height="22">
                </div>
            </div>
        </template>
    </n-popover>

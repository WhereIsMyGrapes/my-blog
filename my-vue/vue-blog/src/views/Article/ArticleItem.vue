<template>
  <div class="article-item" v-animate="['slideUpBigIn']" v-for="article in articleList" :key="article.id">
    <!-- 略缩图 -->
    ...
    <div class="article-info">
      <div class="article-meta">
        ...
        <!-- 文章标签 -->
        <router-link class="meta-item ml" v-for="tag in article.tagVOList" :to="`/tag/${tag.id}`" :key="tag.id">
      ...
      <div class="article-category">
        <svg-icon icon="qizhi" size="0.85rem" style="margin-right: 0.15rem" />
...
.article-btn {
    ...
    color: var(--gary-0);
    background-image: linear-gradient(to right, var(--color-red) 0, var(--color-orange) 100%);
